...
public class XenPit8Feature extends Feature<NoneFeatureConfiguration> {
	public static final XenPit8Feature FEATURE = (XenPit8Feature) new XenPit8Feature().setRegistryName("undogo:xen_pit_8");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenPit8Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.pit8"));
		if (template == null)
			return false;
