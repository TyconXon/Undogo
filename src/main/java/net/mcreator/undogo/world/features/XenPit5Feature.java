...
public class XenPit5Feature extends Feature<NoneFeatureConfiguration> {
	public static final XenPit5Feature FEATURE = (XenPit5Feature) new XenPit5Feature().setRegistryName("undogo:xen_pit_5");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenPit5Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.pit5"));
		if (template == null)
			return false;
