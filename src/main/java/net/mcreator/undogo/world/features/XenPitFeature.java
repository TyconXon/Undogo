...
public class XenPitFeature extends Feature<NoneFeatureConfiguration> {
	public static final XenPitFeature FEATURE = (XenPitFeature) new XenPitFeature().setRegistryName("undogo:xen_pit");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenPitFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.pit"));
		if (template == null)
			return false;
