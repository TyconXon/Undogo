...
public class WastelandLeaveDecorator extends LeaveVineDecorator {
	public static final WastelandLeaveDecorator INSTANCE = new WastelandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wasteland_tree_leave_decorator");
