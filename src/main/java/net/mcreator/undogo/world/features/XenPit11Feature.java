...
public class XenPit11Feature extends Feature<NoneFeatureConfiguration> {
	public static final XenPit11Feature FEATURE = (XenPit11Feature) new XenPit11Feature().setRegistryName("undogo:xen_pit_11");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenPit11Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.pit11"));
		if (template == null)
			return false;
