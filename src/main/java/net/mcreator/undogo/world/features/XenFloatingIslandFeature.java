...
public class XenFloatingIslandFeature extends Feature<NoneFeatureConfiguration> {
	public static final XenFloatingIslandFeature FEATURE = (XenFloatingIslandFeature) new XenFloatingIslandFeature()
			.setRegistryName("undogo:xen_floating_island");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenFloatingIslandFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.floating_island"));
		if (template == null)
			return false;
