package net.mcreator.undogo.world.features.treedecorators;
...
public class WastelandFruitDecorator extends CocoaDecorator {
	public static final WastelandFruitDecorator INSTANCE = new WastelandFruitDecorator();
	public static com.mojang.serialization.Codec<WastelandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wasteland_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public WastelandFruitDecorator() {
		super(0.2f);
	}
