...
public class XenSpireStruct2Feature extends Feature<NoneFeatureConfiguration> {
	public static final XenSpireStruct2Feature FEATURE = (XenSpireStruct2Feature) new XenSpireStruct2Feature()
			.setRegistryName("undogo:xen_spire_struct_2");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public XenSpireStruct2Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("undogo", "xen.spire2"));
		if (template == null)
			return false;
